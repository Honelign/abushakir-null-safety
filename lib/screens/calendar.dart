  ...
  Widget _daysGridList(BuildContext context, ETC a) {
    ...
    return GridView.count(
      ...
      children: List.generate(
          a.monthDays().toList().length + a.monthDays().toList()[0][3] as int,
          (index) {
        if (a.monthDays().toList()[0][3] > 0 &&
          ...
          //  var var1 = a.monthDays().toList()[index - a.monthDays().toList()[0][3] as int][0] as int;
          if (a
                          .monthDays()
                          .toList()[index - a.monthDays().toList()[0][3] as int]
                      [0] ==
                  EtDatetime.now().year &&
              a
                          .monthDays()
            ...
            return Padding(
              ...
              child: Container(
                ...
                width: 2.315 * SizeConfig.widthMultiplier,
                child: Text(
                  "${a.monthDays().toList()[index - a.monthDays().toList()[0][3] as int][2]}",
                  style: TextStyle(color: Colors.black),
                ),
                decoration: BoxDecoration(
